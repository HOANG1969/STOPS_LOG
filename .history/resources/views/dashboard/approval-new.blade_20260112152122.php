...
function renderApprovalRequestsTable(requests) {
...
function viewRequestDetails(requestId) {
    ...
    $.ajax({
        ...
        error: function(xhr) {
            showAlert('danger', 'Không thể tải chi tiết yêu cầu.');
        }
    });
}
...
function filterByStatus(status) {
    ...
    switch(status) {
        case 'pending':
            filteredData = allRequestsData.filter(req => req.status === 'pending');
            break;
        case 'approved_today':
