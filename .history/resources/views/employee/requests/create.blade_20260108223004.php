                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="needed_date" 
                               ...
                               value="{{ old('needed_date', now()->addDay()->format('Y-m-d')) }}" 
...
<div id="selectSupplyModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-96">
            ...
            <div class="p-6">
                <div class="mb-4">
                    <input type="text" id="searchSupply" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Tìm kiếm văn phòng phẩm...">
                </div>
                <div class="overflow-y-auto max-h-64">
                    <table class="min-w-full bg-white border border-gray-200">
                        ...
                        <tbody id="supplyListBody">
                            ...
                            <tr data-supply-id="{{ $supply->id }}" class="hover:bg-gray-50">
                                <td class="px-4 py-2 border border-gray-200 text-sm">{{ $supply->name }}</td>
                                <td class="px-4 py-2 border border-gray-200 text-sm">{{ $supply->specification ?? '-' }}</td>
                                <td class="px-4 py-2 border border-gray-200 text-sm">{{ $supply->unit }}</td>
                                <td class="px-4 py-2 border border-gray-200 text-sm">{{ $supply->stock_quantity }}</td>
