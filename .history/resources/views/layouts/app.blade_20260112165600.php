            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                @if(Auth::user()->isApprover())
                    ...
                    <a href="{{ route('dashboard.approval') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('dashboard.approval') || request()->routeIs('supply-requests.*') ? 'bg-green-500 bg-opacity-80 text-white' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                        <i class="fas fa-clipboard-list mr-3"></i>
