            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                @if(Auth::user()->isEmployee())
                    ...
                    <a href="{{ route('employee.requests.index') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('employee.requests.*') ? 'bg-white text-green-600 font-semibold' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                    ...
                    <a href="{{ route('supply-requests.my-requests') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('supply-requests.my-requests') ? 'bg-white text-green-600 font-semibold' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                ...
                @if(Auth::user()->isApprover())
                    ...
                    <a href="{{ route('supply-requests.index') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('supply-requests.index') ? 'bg-white text-green-600 font-semibold' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                ...
                <div class="border-t border-white border-opacity-20 pt-4 mt-4">
                    ...
                    <a href="{{ route('users.index') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('users.*') ? 'bg-white text-green-600 font-semibold' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                        <i class="fas fa-users mr-3"></i>
                        Quản lý người dùng
                    </a>
                    <a href="{{ route('office-supplies.admin') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('office-supplies.admin') ? 'bg-white text-green-600 font-semibold' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
