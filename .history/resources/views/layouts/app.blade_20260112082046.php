            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                @if(Auth::user()->isApprover())
                    ...
                    <a href="{{ route('dashboard.approval') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('dashboard.approval') ? 'bg-white text-green-600 font-semibold' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
