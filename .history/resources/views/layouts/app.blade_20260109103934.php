    ...
    <div class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-indigo-600 to-purple-700 text-white z-50">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <!-- Dashboard Phê duyệt - Chỉ cho Approver và Admin -->
                ...
                <!-- Danh sách văn phòng phẩm - Tất cả user -->
                ...
                <!-- Đăng ký văn phòng phẩm - Tất cả user -->
                ...
                <!-- Quản lý Phiếu đăng ký - Chỉ cho Approver và Admin -->
                @if(Auth::user()->isApprover() || Auth::user()->isAdmin())
