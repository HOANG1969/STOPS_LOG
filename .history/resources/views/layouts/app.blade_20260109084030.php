...
<body class="bg-gray-100">
    @auth
    <!-- Sidebar -->
    <div class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-indigo-600 to-purple-700 text-white z-50">
        <div class="flex flex-col h-full">
            ...
            <div class="p-4 border-b border-white border-opacity-20">
                ...
                <p class="text-sm text-indigo-200 mt-1">Quản lý văn phòng phẩm</p>
            </div>
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="{{ route('office-supplies.index') }}" 
                   class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('office-supplies.*') ? 'bg-white bg-opacity-20 text-white' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                ...
                @if(Auth::user()->isEmployee() || Auth::user()->isApprover())
                <a href="{{ route('dashboard.employee') }}" 
                   class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('dashboard.employee') ? 'bg-white bg-opacity-20 text-white' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                ...
                <a href="{{ route('supply-requests.my-requests') }}" 
                   class="flex items-center px-4 py-3 rounded-lg transition-colors text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white">
                ...
                <div class="border-t border-white border-opacity-20 pt-4 mt-4">
                    <p class="text-xs text-indigo-300 uppercase tracking-wider mb-2">Quản trị</p>
