            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                @if(Auth::user()->isEmployee())
                    ...
                    <a href="{{ route('employee.requests.index') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('employee.requests.*') ? 'bg-green-500 bg-opacity-80 text-white' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                    ...
                    <a href="{{ route('supply-requests.my-requests') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('supply-requests.my-requests') ? 'bg-green-500 bg-opacity-80 text-white' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
