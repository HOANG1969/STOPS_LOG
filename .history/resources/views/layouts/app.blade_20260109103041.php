        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="{{ route('supply-requests.index') }}" 
                   class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('supply-requests.*') ? 'bg-white bg-opacity-20 text-white' : 'text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
