...
<body class="">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                @if(Auth::user()->isEmployee())
                    ...
                    <a href="{{ route('employee.requests.index') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('employee.requests.*') ? 'bg-white bg-opacity-20 text-white' : 'text-blue-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                    ...
                    <a href="{{ route('supply-requests.my-requests') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('supply-requests.my-requests') ? 'bg-white bg-opacity-20 text-white' : 'text-blue-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                ...
                @if(Auth::user()->isApprover())
                    ...
                    <a href="{{ route('dashboard.approval') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('dashboard.approval') ? 'bg-white bg-opacity-20 text-white' : 'text-blue-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                    ...
                    <a href="{{ route('supply-requests.index') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('supply-requests.index') ? 'bg-white bg-opacity-20 text-white' : 'text-blue-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                ...
                <div class="border-t border-white border-opacity-20 pt-4 mt-4">
                    <p class="text-xs text-blue-300 uppercase tracking-wider mb-2">Quản trị hệ thống</p>
                    <a href="{{ route('users.index') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('users.*') ? 'bg-white bg-opacity-20 text-white' : 'text-blue-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
                        <i class="fas fa-users mr-3"></i>
                        Quản lý người dùng
                    </a>
                    <a href="{{ route('office-supplies.admin') }}" 
                       class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('office-supplies.admin') ? 'bg-white bg-opacity-20 text-white' : 'text-blue-200 hover:bg-white hover:bg-opacity-10 hover:text-white' }}">
    ...
    <div class="ml-64 min-h-screen">
        <!-- Top Navigation -->
        <header class="bg-green-50 shadow-sm border-b border-gray-200">
            <div class="px-6 py-4 flex items-center justify-between">
                ...
                <div class="relative">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <button onclick="toggleUserMenu()" class="flex items-center p-2 rounded-lg hover:bg-green-50 transition-colors">
                                <div class="w-8 h-8 bg-gradient-to-r from-blue-500 to-blue-700 rounded-full flex items-center justify-center text-white text-sm font-medium">
                            ...
                            <div id="userMenu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg border border-gray-200 z-50">
                                <div class="py-1">
                                    <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-green-50">
