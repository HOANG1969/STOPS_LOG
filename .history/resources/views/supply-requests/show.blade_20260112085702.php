                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $statusConfig = [
                                    ...
                                    'approved' => ['class' => 'bg-success', 'text' => 'Đã duyệt - Chờ TCHC check', 'icon' => 'fas fa-check'],
                                    'tchc_checked' => ['class' => 'bg-info', 'text' => 'TCHC đã check - Chờ phê duyệt cuối', 'icon' => 'fas fa-search'],
                                    'tchc_approved' => ['class' => 'bg-success', 'text' => 'TCHC đã phê duyệt - Hoàn thành', 'icon' => 'fas fa-stamp'],
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-sm">
                        ...
                        <tr>
                            ...
                            <td>{{ $request->tchc_approved_at ? \Carbon\Carbon::parse($request->tchc_approved_at)->format('d/m/Y H:i') : 'Chưa phê duyệt' }}</td>
                        </tr>
