                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary" 
                                            onclick="editRequest({{ $request->id }})" title="Sửa">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    @else
                                    <button type="button" class="btn btn-sm btn-outline-info" 
                                            onclick="viewRequest({{ $request->id }})" title="Xem">
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-4">
                                ...
                                <div>Không có phiếu đăng ký nào</div>
                                <button type="button" class="btn btn-primary mt-2" onclick="createNewRequest()">
