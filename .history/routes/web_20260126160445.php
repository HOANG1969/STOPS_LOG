...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware('can:admin-access')->group(function () {
        ...
        // Import Routes
        Route::get('/import/office-supplies', [App\Http\Controllers\Admin\ImportController::class, 'showImportForm'])->name('import.office-supplies');
        Route::post('/import/office-supplies', [App\Http\Controllers\Admin\ImportController::class, 'importOfficeSupplies'])->name('import.office-supplies.process');
    ...
    // Backward compatibility - redirect old user routes to new admin routes
    Route::prefix('admin/users')->name('users.')->middleware('can:admin-access')->group(function () {
        ...
        Route::get('/create', function() { return redirect()->route('admin.users.create'); });
        Route::get('/{user}', function($user) { return redirect()->route('admin.users.show', $user); });
        Route::get('/{user}/edit', function($user) { return redirect()->route('admin.users.edit', $user); });
    });
});
