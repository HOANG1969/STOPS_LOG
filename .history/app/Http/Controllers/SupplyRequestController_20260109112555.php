...
class SupplyRequestController extends Controller
{
     ...
     */
    public function approve(Request $httpRequest, SupplyRequest $request): JsonResponse
    {
        $user = Auth::user();
        ...
        \Log::info('Approve attempt', [
            ...
            'request_dept' => $request->requester_department,
            'canBeApproved' => $request->canBeApprovedBy($user)
        ]);
     ...
     */
    public function reject(Request $httpRequest, SupplyRequest $request): JsonResponse
    {
        $validated = $request->validate([
