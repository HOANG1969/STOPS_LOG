...
class EmployeeRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.requests.index-simple', compact('requests'));
    }
    ...
    public function create()
    {
        ...
        return view('employee.requests.create-simple', compact('officeSupplies'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'items.required' => 'Vui lòng thêm ít nhất một văn phòng phẩm.',
            'items.min' => 'Vui lòng thêm ít nhất một văn phòng phẩm.',
            'items.*.supply_id.required' => 'Thiếu thông tin văn phòng phẩm.',
            'items.*.supply_id.exists' => 'Văn phòng phẩm được chọn không tồn tại.',
            'items.*.quantity.required' => 'Vui lòng nhập số lượng.',
            'items.*.quantity.integer' => 'Số lượng phải là số nguyên.',
            'items.*.quantity.min' => 'Số lượng phải lớn hơn 0.',
            'items.*.quantity.max' => 'Số lượng không được vượt quá 999.',
        ...
        try {
            ...
            $supplyRequest = SupplyRequest::create([
                ...
                'requester_department' => $user->department ?? 'N/A',
    ...
    public function show(SupplyRequest $request)
    {
        ...
        return view('employee.requests.show-simple', compact('request'));
    }
    ...
    public function history(SupplyRequest $request)
    {
        ...
        return view('employee.requests.history-simple', compact('request', 'timeline'));
    }
