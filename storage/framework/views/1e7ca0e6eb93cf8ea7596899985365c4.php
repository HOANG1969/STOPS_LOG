                ...
                <p>Đăng nhập vào hệ thống quản lý</p>
                    ...
                    <form method="POST" action="<?php echo e(route('login.post')); ?>">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="<?php echo e(old('username')); ?>" required>
                            <label for="username">
...
</html><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views/auth/login.blade.php ENDPATH**/ ?>