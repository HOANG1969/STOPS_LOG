...
<?php $__env->startSection('title', 'TCHC Manager - Phê duyệt cuối VPP'); ?>

<?php $__env->startSection('content'); ?>
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 30px;">
        <div>
            <h2 class="mb-1">Phê duyệt cuối văn phòng phẩm</h2>
        ...
        <!-- đếm số phiếu đang chờ phê duyệt cuối 
        <div class="d-flex align-items-center">
            <span class="badge bg-purple text-white fs-6 me-3" style="background-color: #6366f1;">
                <i class="fas fa-stamp me-1"></i><?php echo e($pendingRequests->total()); ?> phiếu chờ phê duyệt cuối
            </span>
        </div> -->
    </div>
        ...
        <div class="card-header bg-white">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="mb-0">
                    ...
                    Danh sách phiếu nhân sự TCHC đã kiểm tra - Chờ lãnh đạo TCHC phê duyệt
                </h6>
                <div>
            ...
            <!-- Form tìm kiếm -->
            <form method="GET" action="<?php echo e(route('tchc.manager.dashboard')); ?>" class="row g-3">
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    ...
                    <select name="status" id="status" class="form-select">
                        ...
                        <option value="tchc_checked" <?php echo e(request('status', 'tchc_checked') == 'tchc_checked' ? 'selected' : ''); ?>>
                            Chờ phê duyệt 
                        </option>
                        <option value="tchc_approved" <?php echo e(request('status') == 'tchc_approved' ? 'selected' : ''); ?>>
                            Đã phê duyệt
                        </option>
                        <option value="tchc_rejected" <?php echo e(request('status') == 'tchc_rejected' ? 'selected' : ''); ?>>
                            Đã từ chối
                        </option>
                    </select>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small class="text-muted"><?php echo e($request->approved_at->format('d/m/Y')); ?></small>
                            </td>
                            <td>
                                <div class="fw-bold"><?php echo e($request->tchcChecker->name); ?></div>
                                <?php if($request->tchc_check_notes): ?>
                                <small class="text-muted" title="<?php echo e($request->tchc_check_notes); ?>">
                                    <i class="fas fa-comment"></i> Có ghi chú
                                </small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($request->status === 'tchc_checked'): ?>
                                    <div><?php echo e($request->tchc_checked_at->format('d/m/Y')); ?></div>
                                    <small class="text-muted"><?php echo e($request->tchc_checked_at->format('H:i')); ?></small>
                                <?php elseif($request->status === 'tchc_approved'): ?>
                                    <div><?php echo e($request->tchc_approved_at->format('d/m/Y')); ?></div>
                                    <small class="text-muted"><?php echo e($request->tchc_approved_at->format('H:i')); ?> (Đã phê duyệt)</small>
                                <?php elseif($request->status === 'tchc_rejected'): ?>
                                    <div><?php echo e($request->tchc_approved_at->format('d/m/Y')); ?></div>
                                    <small class="text-muted"><?php echo e($request->tchc_approved_at->format('H:i')); ?> (Đã từ chối)</small>
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="badge <?php echo e($statusConfig['class']); ?>"><?php echo e($statusConfig['text']); ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-success" 
                                            data-bs-toggle="modal" data-bs-target="#approveModal<?php echo e($request->id); ?>" title="Phê duyệt">
                                        <i class="fas fa-check"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-danger" 
                                            data-bs-toggle="modal" data-bs-target="#rejectModal<?php echo e($request->id); ?>" title="Từ chối">
                        ...
                        <div class="modal fade" id="approveModal<?php echo e($request->id); ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="POST" action="<?php echo e(route('tchc.manager.approve', $request->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <div class="modal-header bg-success text-white">
                                            <h5 class="modal-title">Phê duyệt cuối <?php echo e($request->request_code ?? '#'.$request->id); ?></h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-info">
                                                ...
                                                <?php echo e($request->tchc_check_notes); ?>

                                            </div>
                                            <?php endif; ?>
                                            <div class="mb-3">
                                                <label for="tchc_approval_notes<?php echo e($request->id); ?>" class="form-label">Ghi chú phê duyệt (tùy chọn)</label>
                                                <textarea name="tchc_approval_notes" id="tchc_approval_notes<?php echo e($request->id); ?>" 
                        ...
                        <div class="modal fade" id="rejectModal<?php echo e($request->id); ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="POST" action="<?php echo e(route('tchc.manager.reject', $request->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <div class="modal-header bg-danger text-white">
                                            <h5 class="modal-title">Từ chối phiếu <?php echo e($request->request_code ?? '#'.$request->id); ?></h5>
                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <?php endif; ?>
                                            <div class="mb-3">
                                                <label for="tchc_rejection_notes<?php echo e($request->id); ?>" class="form-label">Lý do từ chối <span class="text-danger">*</span></label>
                                                <textarea name="tchc_approval_notes" id="tchc_rejection_notes<?php echo e($request->id); ?>" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views\tchc\manager\dashboard.blade.php ENDPATH**/ ?>