                ...
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <h5 class="mb-1"><?php echo e($user->full_name ?? $user->name); ?></h5>
                            <p class="text-muted mb-2"><?php echo e($user->position ?? 'Nhân viên'); ?></p>
                            <p class="text-muted mb-3">
                                <i class="fas fa-building me-1"></i><?php echo e($user->department ?? 'N/A'); ?>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <?php echo e($user->employee_code ?? 'Chưa cập nhật'); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <?php echo e($user->full_name ?? 'Chưa cập nhật'); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <?php echo e($user->position ?? 'Chưa cập nhật'); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <?php echo e($user->department ?? 'Chưa cập nhật'); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <?php elseif($user->is_department_head): ?>
                                        <span class="badge bg-success">Trưởng phòng</span>
                                    <?php elseif($user->is_tchc_manager): ?>
                                        <span class="badge bg-info">Lãnh đạo TCHC</span>
                                    <?php elseif($user->is_tchc_checker): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views\profile\show.blade.php ENDPATH**/ ?>