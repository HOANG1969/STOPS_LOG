...
<?php $__env->startSection('title', 'Thêm văn phòng phẩm'); ?>
<?php $__env->startSection('page-title', 'Thêm văn phòng phẩm mới'); ?>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('office-supplies.admin.manage')); ?>" class="btn btn-outline-secondary btn-sm">
...
document.getElementById('createSupplyForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route('office-supplies.store')); ?>', {
            method: 'POST',
            headers: {
        ...
        if (result.success) {
            ...
            setTimeout(() => {
                window.location.href = '<?php echo e(route('office-supplies.admin.manage')); ?>';
            }, 2000);
        } else {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views\office-supplies\add.blade.php ENDPATH**/ ?>