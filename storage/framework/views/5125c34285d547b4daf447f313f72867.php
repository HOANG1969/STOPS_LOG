...
<?php $__env->startSection('title', 'Hệ thống quản lý văn phòng phẩm'); ?>
...
window.addEventListener('load', function() {
    ...
    const interval = setInterval(() => {
        ...
        if (progress >= 100) {
            ...
            <?php if(auth()->user()->isApprover() || auth()->user()->isAdmin()): ?>
                window.location.href = "<?php echo e(route('dashboard.approval')); ?>";
            <?php else: ?>
                window.location.href = "<?php echo e(route('dashboard.employee')); ?>";
            <?php endif; ?>
        }
    }, 100);
});
...
<?php $__env->stopSection(); ?>
    ...
    <div class="tab-content" id="mainTabsContent">
        ...
        <div class="tab-pane fade show active" id="request" role="tabpanel">
            <?php echo $__env->make('partials.request-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <!-- Yêu cầu của tôi -->
        <div class="tab-pane fade" id="my-requests" role="tabpanel">
            <?php echo $__env->make('partials.my-requests', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <!-- Phê duyệt yêu cầu -->
        <?php if(auth()->user()->isApprover() || auth()->user()->isAdmin()): ?>
        <div class="tab-pane fade" id="approval" role="tabpanel">
            <?php echo $__env->make('partials.approval-requests', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php endif; ?>
        ...
        <div class="tab-pane fade" id="supplies" role="tabpanel">
            <?php echo $__env->make('partials.manage-supplies', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        ...
        <div class="tab-pane fade" id="users" role="tabpanel">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('users.index')); ?>" class="btn btn-primary" target="_blank">
...
function loadOfficeSuppliesForRequest() {
    $.get('<?php echo e(route("office-supplies.index", [], false)); ?>', function(data) {
        let suppliesHtml = '';
        data.forEach(supply => {
            suppliesHtml += `
...
function loadMyRequests() {
    $.get('<?php echo e(route("supply-requests.my-requests", [], false)); ?>', function(data) {
        updateMyRequestsTable(data);
    });
}

function loadApprovalRequests() {
    $.get('<?php echo e(route("supply-requests.for-approval", [], false)); ?>', function(data) {
        updateApprovalRequestsTable(data);
    });
}

function loadOfficeSupplies() {
    $.get('<?php echo e(route("office-supplies.admin", [], false)); ?>', function(data) {
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <a href="<?php echo e(route('office-supplies.create')); ?>" class="btn btn-outline-primary btn-lg w-100">
                            <i class="fas fa-plus me-2"></i>
                            Tạo yêu cầu mới
                        </a>
                    </div>
                    <div class="col-md-6 mb-3">
                        <a href="<?php echo e(route('office-supplies.index')); ?>" class="btn btn-outline-success btn-lg w-100">
...
function loadUserStats() {
    fetch('<?php echo e(route('users.stats')); ?>')
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views\dashboard.blade.php ENDPATH**/ ?>