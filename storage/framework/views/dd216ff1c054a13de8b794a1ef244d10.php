...
<?php $__env->startSection('title', 'Dashboard - Phê duyệt'); ?>
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0"><?php echo e($user->full_name); ?> - <?php echo e($user->position); ?> | Bộ phận: <?php echo e($user->department); ?></p>
        </div>
        <div class="btn-group">
        ...
        <div class="col-md-3">
            <div class="card border-warning" style="cursor: pointer;" onclick="filterByStatus('pending')">
                <div class="card-body text-center">
                    ...
                    <h4 class="text-warning"><?php echo e($stats['pending_count']); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card border-success" style="cursor: pointer;" onclick="filterByStatus('approved_today')">
                <div class="card-body text-center">
                    ...
                    <h4 class="text-success"><?php echo e($stats['approved_today']); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card border-info" style="cursor: pointer;" onclick="filterByStatus('approved_month')">
                <div class="card-body text-center">
                    ...
                    <h4 class="text-info"><?php echo e($stats['approved_this_month']); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card border-primary" style="cursor: pointer;" onclick="filterByStatus('all')">
                <div class="card-body text-center">
                    ...
                    <h4 class="text-primary"><?php echo e($stats['total_requests']); ?></h4>
...
$(document).ready(function() {
    console.log('Dashboard approval page loaded');
...
function loadApprovalRequests() {
    ...
    $.ajax({
        url: '<?php echo e(route("supply-requests.all")); ?>',
        method: 'GET',
...
function renderTable(requests) {
    ...
    requests.forEach(function(request) {
        ...
        // Đơn chỉ có thể phê duyệt khi ở trạng thái pending
...
function getStatusBadge(status) {
    switch(status) {
        ...
        case 'approved':
            return '<span class="badge bg-info">Chờ TCHC kiểm tra</span>';
        case 'tchc_checked':
            return '<span class="badge bg-primary">TCHC đã kiểm tra</span>';
        case 'tchc_approved':
            return '<span class="badge bg-success">Đã hoàn thành</span>';
        case 'tchc_rejected':
            return '<span class="badge bg-danger">TCHC từ chối</span>';
        case 'rejected':
...
function quickApprove(requestId) {
    console.log('Quick approve for request ID:', requestId);
...
function quickReject(requestId) {
    console.log('Quick reject for request ID:', requestId);
    currentRequestId = requestId;
    // Clear previous form data
    $('[name="rejection_reason"]').val('');
...
function approveRequestById(requestId) {
    $.ajax({
        url: `/dashboard/approve/${requestId}`,
        method: 'POST',
        data: {
            action: 'approve',
...
function submitRejectRequest() {
    ...
    if (!currentRequestId) {
        showAlert('danger', 'Không tìm thấy ID yêu cầu!');
        return;
    }
    
    $.ajax({
        url: `/dashboard/approve/${currentRequestId}`,
        method: 'POST',
        data: {
            action: 'reject',
            notes: reason,
        ...
        success: function(response) {
            if (response.success) {
                ...
                $('[name="rejection_reason"]').val(''); // Clear form
                loadApprovalRequests(); // Reload table
            } else {
                showAlert('danger', 'Có lỗi: ' + response.message);
            }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views/dashboard/approval-new.blade.php ENDPATH**/ ?>