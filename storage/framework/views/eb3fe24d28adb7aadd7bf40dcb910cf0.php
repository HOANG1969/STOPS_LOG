...
<?php $__env->startSection('page-title', 'Import văn phòng phẩm'); ?>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('office-supplies.admin')); ?>" class="btn btn-outline-secondary btn-sm">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="successActions" class="mt-3 text-center" style="display: none;">
                                <a href="<?php echo e(route('office-supplies.admin')); ?>" class="btn btn-success">
...
document.getElementById('importForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route('office-supplies.import')); ?>', {
            method: 'POST',
            body: formData,
            headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views\office-supplies\import.blade.php ENDPATH**/ ?>