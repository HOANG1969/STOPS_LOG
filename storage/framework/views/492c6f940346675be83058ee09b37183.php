            ...
            <form id="request-form">
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        ...
                        <div class="form-control-plaintext"><?php echo e(Auth::user()->department); ?></div>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label"><strong>Người tạo:</strong></label>
                        <div class="form-control-plaintext"><?php echo e(Auth::user()->full_name ?? Auth::user()->name); ?></div>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label"><strong>Ngày:</strong></label>
                        <div class="form-control-plaintext"><?php echo e(now()->format('d/m/Y')); ?></div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="needed_date" class="form-control" value="<?php echo e(date('Y-m-d', strtotime('+7 days'))); ?>" required>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button type="button" class="btn btn-success" onclick="console.log('Add VPP clicked'); showSupplySelector()">
...
function showSupplySelector() {
    console.log('Show supply selector called');
    console.log('Current allSupplies length:', allSupplies.length);
...
function loadOfficeSuppliesForRequest(callback = null) {
    ...
    $.ajax({
        ...
        success: function(supplies) {
            ...
            console.log('First 3 supplies:', supplies.slice(0, 3));
        ...
        error: function(xhr, status, error) {
            ...
            showAlert('danger', 'Không thể tải danh sách văn phòng phẩm. Vui lòng thử lại sau. (Lỗi: ' + xhr.status + ')');
        }
    });
}
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                setTimeout(() => {
                    window.location.href = '<?php echo e(route("supply-requests.my-requests")); ?>';
                }, 2000);
            } else {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views\office-supplies\request.blade.php ENDPATH**/ ?>