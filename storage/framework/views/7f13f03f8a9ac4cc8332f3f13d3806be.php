...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 20px;">
        <h1 style="font-size: 1.3rem; font-weight: 500; color: #2112f5;">
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        name="status" 
                                        required>
                                    <option value="open" <?php echo e(old('status', $stop->status) == 'open' ? 'selected' : ''); ?>>Chưa xử lý</option>
                                    <option value="in-progress" <?php echo e(old('status', $stop->status) == 'in-progress' ? 'selected' : ''); ?>>Đang xử lý</option>
                                    <option value="completed" <?php echo e(old('status', $stop->status) == 'completed' ? 'selected' : ''); ?>>Hoàn thành</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      name="score_note"
                                      rows="3"
                                      placeholder="Nhập ghi chú cho lần chấm điểm này"><?php echo e(old('score_note')); ?></textarea>
        ...
        <!-- <div class="col-lg-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <small>
                        <p><strong>Người ghi nhận:</strong><br><?php echo e($stop->user->name); ?></p>
                        <p><strong>Ngày tạo:</strong><br><?php echo e($stop->created_at->format('d/m/Y H:i')); ?></p>
                        <p><strong>Cập nhật lần cuối:</strong><br><?php echo e($stop->updated_at->format('d/m/Y H:i')); ?></p>
                    </small>
                </div>
            </div>
        </div> -->
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <!-- <div class="mb-3">
                        ...
                        <p class="mb-1 small"><strong>Mức:</strong> <?php echo e($latestShiftLeaderUpdate->priority_level !== null ? 'Mức ' . $latestShiftLeaderUpdate->priority_level : 'Chưa chấm'); ?></p>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="mb-1 small"><strong>Mức:</strong> <?php echo e($latestSafetyOfficerUpdate->priority_level !== null ? 'Mức ' . $latestSafetyOfficerUpdate->priority_level : 'Chưa chấm'); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views/stops/show.blade.php ENDPATH**/ ?>