...
<?php $__env->startSection('title', 'Import nhân sự'); ?>
        ...
        <div class="col-md-10">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('users.import.template')); ?>" class="btn btn-success">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('users.import.process')); ?>" method="POST" enctype="multipart/form-data" id="importUserForm">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KDNVPP-new\KDNVPP-new\resources\views\admin\users\import.blade.php ENDPATH**/ ?>