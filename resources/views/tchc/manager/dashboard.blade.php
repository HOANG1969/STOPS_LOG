    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    <a href="{{ route('supply-requests.export', request()->all()) }}" class="btn btn-success btn-sm me-2">
                        <i class="fas fa-file-excel me-1"></i>Export Tổng quan
                    </a>
                    <a href="{{ route('supply-requests.export-items', request()->all()) }}" class="btn btn-primary btn-sm">
            ...
            <form method="GET" action="{{ route('tchc.manager.dashboard') }}" class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <select name="period" id="period" class="form-select">
                        <option value="">Tất cả</option>
                        @for($m = 1; $m <= 12; $m++)
                        <option value="{{ $m }}" {{ request('period') == $m ? 'selected' : '' }}>Tháng {{ $m }}</option>
                        @endfor
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    ...
                    <select name="area" id="area" class="form-select">
                        <option value="">Tất cả</option>
                        <option value="HCM" {{ request('area') == 'HCM' ? 'selected' : '' }}>TP.HCM</option>
