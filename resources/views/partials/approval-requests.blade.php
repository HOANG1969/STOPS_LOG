    ...
    <div class="card-header">
        <h5 class="mb-0">
            ...
            @if(auth()->user()->isApprover())
                <span class="badge bg-info ms-2">{{ auth()->user()->department }}</span>
            @endif
        </h5>
    </div>
    <div class="card-body">
...
function approveRequest() {
    ...
    $.ajax({
        url: `{{ url('supply-requests') }}/${currentRequestId}/approve`,
        method: 'POST',
        data: {
...
function confirmReject() {
    ...
    $.ajax({
        url: `{{ url('supply-requests') }}/${currentRequestId}/reject`,
        method: 'POST',
        data: {
