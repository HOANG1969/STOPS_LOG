                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('phone') is-invalid @enderror" id="phone" name="phone">
                                    ...
                                    <option value="HTSX" {{ old('phone', $user->phone) == 'HTSX' ? 'selected' : '' }}>HTSX</option>
                                    <option value="VH01" {{ old('phone', $user->phone) == 'VH01' ? 'selected' : '' }}>VH01</option>
                                    <option value="VH02" {{ old('phone', $user->phone) == 'VH02' ? 'selected' : '' }}>VH02</option>
                                    <option value="VH03" {{ old('phone', $user->phone) == 'VH03' ? 'selected' : '' }}>VH03</option>
                                    <option value="VH04" {{ old('phone', $user->phone) == 'VH04' ? 'selected' : '' }}>VH04</option>
                                </select>
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
