...
@section('title', 'Đăng ký văn phòng phẩm')
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    @elseif(in_array($request->status, ['rejected', 'tchc_rejected']))
                                    <button type="button" class="btn btn-sm btn-outline-info" 
                                            onclick="viewRequest({{ $request->id }})" title="Xem chi tiết">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-primary" 
                                            onclick="editRequest({{ $request->id }})" title="Chỉnh sửa">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-success" 
                                            onclick="resubmitRequestFromTable({{ $request->id }})" title="Gửi lại">
                                        <i class="fas fa-redo"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-danger" 
                                            onclick="deleteRequestFromTable({{ $request->id }})" title="Hủy phiếu">
...
function loadOfficeSuppliesForRequest(callback = null) {
    ...
    $.ajax({
        url: '{{ route("office-supplies.api.for-request", [], false) }}',
        method: 'GET',
        headers: {
...
function submitRequest(status = 'pending') {
    ...
    $.ajax({
        url: isEditMode ? `/supply-requests/${formData.request_id}` : '{{ route("supply-requests.store", [], false) }}',
