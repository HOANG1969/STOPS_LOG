                    ...
                    <form action="{{ route('stops.update', $stop) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('score_note') is-invalid @enderror"
                                      ...
                                      name="score_note"
                                      rows="3"
                                      placeholder="Nhập ghi chú cho lần chấm điểm này">{{ old('score_note') }}</textarea>
                            @error('score_note')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        <!-- <div class="col-lg-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <small>
                        <p><strong>Người ghi nhận:</strong><br>{{ $stop->user->name }}</p>
                        <p><strong>Ngày tạo:</strong><br>{{ $stop->created_at->format('d/m/Y H:i') }}</p>
                        <p><strong>Cập nhật lần cuối:</strong><br>{{ $stop->updated_at->format('d/m/Y H:i') }}</p>
                    </small>
                </div>
            </div>
        </div> -->
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <!-- <div class="mb-3">
                        ...
                        <p class="mb-1 small"><strong>Mức:</strong> {{ $latestShiftLeaderUpdate->priority_level !== null ? 'Mức ' . $latestShiftLeaderUpdate->priority_level : 'Chưa chấm' }}</p>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="mb-1 small"><strong>Mức:</strong> {{ $latestSafetyOfficerUpdate->priority_level !== null ? 'Mức ' . $latestSafetyOfficerUpdate->priority_level : 'Chưa chấm' }}</p>
